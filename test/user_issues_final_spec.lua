...
describe('user reported issues - final verification', function()
  local screen
  ...
  it('issue 1: <c-w> with consecutive CJK should delete only one token', function()
  ...
  it('issue 2: w from start of line with CJK should not jump to next line', function()
  ...
  it('issue 3: w from space should not jump to next line', function()
